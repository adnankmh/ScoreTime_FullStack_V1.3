...
ابدأ من [دليل التشغيل الكامل](docs/START_HERE_V172_AR.md)، ثم راجع [ملاحظات الإصدار](docs/RELEASE_V172_AR.md) و[معمارية البيانات والرصيد](docs/ARCHITECTURE_V172_AR.md).
...
في V1.7.2 أصبح مجلد `mobile-flutter/web` جزءاً متتبعاً من المشروع، ويعيد Workflow إنشاء بيانات منصة Web تلقائياً إذا نقصت، ثم يعيد ملفات الهوية والتصميم قبل البناء.
