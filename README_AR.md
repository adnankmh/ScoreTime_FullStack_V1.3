...
ابدأ من [دليل التشغيل المبسط](docs/START_HERE_V173_AR.md)، ثم راجع [ملاحظات الإصدار](docs/RELEASE_V173_AR.md) و[معمارية البيانات والرصيد](docs/ARCHITECTURE_V172_AR.md).

يمكن ترك رابط Laravel فارغاً عند تشغيل GitHub Actions. عند أول تشغيل تعرض V1.7.3 ثلاثة مسارات واضحة: معاينة صريحة ببيانات توضيحية، أو ربط Android بالكمبيوتر على الشبكة المحلية، أو ربط الموقع والتطبيق بخادم Laravel منشور عبر HTTPS.

يشغّل `START_SCORETIME_WINDOWS.ps1` Laravel على الشبكة الخاصة ويطبع عنوان Android الجاهز بصيغة `http://IP:8000/api/v1`. يسمح التطبيق بـHTTP فقط لعناوين LAN الخاصة، ويطلب HTTPS لأي خادم عام.
