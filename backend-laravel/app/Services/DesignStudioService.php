...
class DesignStudioService {
 public function bootstrap(string $surface='web', string $locale='en', ?string $host=null, ?string $visitorKey=null): array {
  $version=(int)Cache::get('scoretime:design:version',1);
  return Cache::remember("design:v09:$version:$surface:$locale:".sha1((string)$host),120,function()use($surface,$locale,$host,$visitorKey){
