...
class PreferenceController extends Controller {
 public function locale(Request $r,string $locale){abort_unless(in_array($locale,['ar','en','tr','fr','es'],true),404);$r->session()->put('locale',$locale);if($r->user())$r->user()->update(['locale'=>$locale]);return back();}
