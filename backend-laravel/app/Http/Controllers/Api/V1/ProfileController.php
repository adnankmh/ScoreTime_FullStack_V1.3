...
class ProfileController extends Controller {
 ...
 public function update(Request $r){$u=$r->user();$d=$r->validate(['name'=>'required|string|max:120','username'=>['required','string','max:60',Rule::unique('users')->ignore($u->id)],'bio'=>'nullable|string|max:280','locale'=>'nullable|in:en,ar,fr,es,de,tr','theme'=>'nullable|in:stadium,midnight,light','font_scale'=>'nullable|numeric|min:.85|max:1.30','profile_public'=>'nullable|boolean']);$u->update($d);return response()->json(['data'=>$u->fresh()]);}
