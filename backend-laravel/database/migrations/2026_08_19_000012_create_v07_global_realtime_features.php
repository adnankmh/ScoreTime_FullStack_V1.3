...
return new class extends Migration {
 public function up(): void {
  ...
  Schema::create('prediction_seasons', function(Blueprint $t){$t->id();$t->string('name',120);$t->string('slug',140)->unique();$t->dateTime('starts_at')->index();$t->dateTime('ends_at')->index();$t->boolean('is_active')->default(true)->index();$t->json('scoring_rules')->nullable();$t->timestamps();});
