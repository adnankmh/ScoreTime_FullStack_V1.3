@extends('layouts.app')
@section('title','V0.6 Global Control Center')
@section('content')
<div class="hero"><span class="eyebrow">ADNAN CONTROL ROOM • V0.6</span><h1>Global Football Operations</h1><p>Realtime visual intelligence, discovery, growth, premium and fan engagement telemetry.</p></div>
