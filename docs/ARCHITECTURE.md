...
Provider secrets stay in server environment variables. Public health endpoints are passive and do not spend provider quota. Details are in [the V1.7 data architecture](ARCHITECTURE_V170_AR.md).
