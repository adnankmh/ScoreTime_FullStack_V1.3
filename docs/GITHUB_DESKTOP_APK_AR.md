# بناء ScoreTime V1.7.1 APK باستخدام GitHub Desktop — بدون Android Studio
...
9. بعد النجاح نزّل Artifact باسم `ScoreTime-V1.7.1-Android`؛ بداخله APK للاختبار وAAB. وقّع إصدار المتجر بمفتاحك الخاص قبل النشر العام.
